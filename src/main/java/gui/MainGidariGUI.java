...
public class MainGidariGUI extends JFrame {
	...
	public MainGidariGUI(Driver driver) {
		...
		jButtonAddCar.setText(ResourceBundle.getBundle("Etiquetas").getString("MainGidariGUI.AddCar"));
		...
		jButtonRemoveRide.setText(ResourceBundle.getBundle("Etiquetas").getString("MainGidariGUI.RemoveRide"));
		...
		jButtonSeeMovements.setText(ResourceBundle.getBundle("Etiquetas").getString("MainBidaiariGUI.SeeMovements"));
